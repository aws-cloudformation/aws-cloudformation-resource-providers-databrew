...
public class ReadHandlerTest {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final DescribeRulesetResponse describeRulesetResponse = DescribeRulesetResponse.builder()
                .description(TestUtil.RULESET_DESCRIPTION)
                .name(TestUtil.RULESET_NAME)
                .targetArn(TestUtil.RULESET_TARGET_ARN)
                .rules(TestUtil.createRulesList())
                .tags(TestUtil.createTags())
                .build();

        software.amazon.databrew.ruleset.ResourceModel resourceModel = ModelHelper.constructModel(describeRulesetResponse);
        doReturn(describeRulesetResponse)
                .when(proxy)
    ...
    @Test
    public void handleRequest_FailedRead_ValidationException() {
    ...
    @Test
    public void handleRequest_FailedRead_DatabrewException() {
